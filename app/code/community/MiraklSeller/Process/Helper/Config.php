...
class MiraklSeller_Process_Helper_Config extends Mage_Core_Helper_Abstract
{
    ...
    {
        return Mage::getStoreConfig(self::XML_PATH_SHOW_FILE_MAX_SIZE);
    }
    ...
    {
        return Mage::getStoreConfig(self::XML_PATH_PROCESS_TIMEOUT_DELAY);
    }
    ...
    {
        return Mage::getStoreConfigFlag(self::XML_PATH_AUTO_ASYNC_EXECUTION);
    }
}
