...
class MiraklSeller_Api_Helper_Shipment extends MiraklSeller_Api_Helper_Client_MMP
{
    /**
     ...
     */
    public function getShipments(Connection $connection, array $orderIds = array(), array $stateCodes = array(), $limit = 10)
    {
