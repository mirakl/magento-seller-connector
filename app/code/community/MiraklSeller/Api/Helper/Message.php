...
class MiraklSeller_Api_Helper_Message extends MiraklSeller_Api_Helper_Client_MMP
{
    /**
    ...
    public function downloadThreadMessageAttachment(Connection $connection, $attachmentId)
    {
        ...
        Mage::dispatchEvent('mirakl_seller_api_download_thread_message_attachment_before', array(
            'request' => $request
        ));
    ...
    public function getThreadDetails(Connection $connection, $threadId)
    {
        ...
        Mage::dispatchEvent('mirakl_seller_api_get_thread_details_before', array('request' => $request));
    ...
    public function getThreads(Connection $connection, $entityType = null, $entityId = null, $limit = null, $token = null)
    {
        ...
        Mage::dispatchEvent('mirakl_seller_api_get_threads_before', array('request' => $request));
    ...
    public function replyToThread(Connection $connection, $threadId, ThreadReplyMessageInput $messageInput, $files = null)
    {
        ...
        Mage::dispatchEvent('mirakl_seller_api_reply_to_thread_before', array('request' => $request));
