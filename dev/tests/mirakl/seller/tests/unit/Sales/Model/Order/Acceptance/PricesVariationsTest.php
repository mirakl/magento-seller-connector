<?php
namespace Mirakl\Test\Unit\Sales\Model\Order\Acceptance;
 ...
 * @group sales
 * @group model
 * @coversDefaultClass \MiraklSeller_Sales_Model_Order_Acceptance_PricesVariations
 */
class PricesVariationsTest extends TestCase
{
    ...
    {
        /** @var \MiraklSeller_Sales_Model_Order_Acceptance_PricesVariations|\PHPUnit_Framework_MockObject_MockObject $modelMock */
        $modelMock = $this->getMockBuilder(\MiraklSeller_Sales_Model_Order_Acceptance_PricesVariations::class)
